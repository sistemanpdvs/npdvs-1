...
cliupdate () {
  ...
  wget https://raw.githubusercontent.com/sistemaclipdvs/npdvs/master/npdvs.sh -O $spath/npdvs.sh &>/dev/null
...
logoNPDVs && echo -e " ${y}Inicializando CliPDVs...${endc}" && checkinternet
# -------------------------------------------------------
...
${g}[ ${y}12${end}${g}]${end} ${vr} MGV Server${end} ${y}(Desktop)${end}
${g}[ ${y}13${end}${g}]${end} ${vr} Acesso Gateway Filiais${end} ${y}(Desktop)${end}
