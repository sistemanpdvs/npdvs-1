...
cliupdate () {
  ...
  wget https://raw.githubusercontent.com/sistemaclipdvs/CliPDVs/master/npdvs.sh -O $spath/npdvs.sh &>/dev/null
...
# New Version Check & Update
CLiCheck () {
  changelog=$(curl --silent -q https://raw.githubusercontent.com/sistemaclipdvs/CliPDVs/master/changelog.txt)
  uversion=$(curl --silent -q https://raw.githubusercontent.com/sistemaclipdvs/CliPDVs/master/version.txt)
...
logoCliPDVs && echo -e " ${y}Inicializando CliPDVs...${endc}" 
# -------------------------------------------------------
...
mgv_server () {
  logoCliPDVs
echo -e " ${vr}ACESSO MGV SERVER (CliPDVs)
---------------------------------------------------${end}
...
---------------------------------------------------${end}
 ${y}LOJA${end}        ${bu}CIDADE${endc}          ${vr}FAIXA${endc}
  ...
  434 - ${c}CAMINO BARREIRINHAS${endc}		
...
${g}[ ${y}11${end}${g}]${end} ${vr} MGV Server${end} ${y}(Desktop)${end}
${g}[ ${y}12${end}${g}]${end} ${vr} Acesso Gateway Filiais${end} ${y}(Desktop)${end}
${g}[ ${y}13${end}${g}]${end} ${vr} Acesso Importa PDVs${end}
${g}----------------------------------------- ${end}
