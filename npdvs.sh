...
${g}   105        04      192.168.3.124  ${endc}
${vr}   106        05      192.168.3.25   ${endc}
${g}   107        06      192.168.3.102  ${endc}
${vr}   108        07      192.168.3.103  ${endc}
${g}   109        08      192.168.3.104  ${endc}
${vr}   110        09      192.168.3.139  ${endc}
${g}   111        10      192.168.3.105  ${endc}
${vr}   112        11      192.168.3.107  ${endc}
${g}   113        12      192.168.3.120  ${endc}
${vr}   114        13      192.168.3.106  ${endc}
${g}   115        14      192.168.3.110  ${endc}
${vr}   116        15      192.168.3.11   ${endc}
${g}   117        16      192.168.3.112  ${endc}
${vr}   118        17      192.168.3.113  ${endc} 
${g}   119        18      192.168.3.114  ${endc}
${vr}   128        19      192.168.3.128  ${endc}
${g}   121        20      192.168.3.116  ${endc}
${vr}   126        21      192.168.3.132  ${endc}
${g}   122        22      192.168.3.55   ${endc}
${vr}   124    ELETRO 01   192.168.3.117  ${endc}
${g}   125    ELETRO 02   192.168.3.225  ${endc}
${vr}   127     PADARIA    192.168.3.138  ${endc}
${g}   120     BALCÃO     192.168.3.130  ${endc}
${vr}   126     BOTECO     192.168.3.132  ${end}"
    echo
}
#LOJA =========
# NPDVs Logo
